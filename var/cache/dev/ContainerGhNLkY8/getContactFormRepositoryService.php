 ...
 */
class getContactFormRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContactFormRepository' shared autowired service.
     *
     * @return \App\Repository\ContactFormRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContactFormRepository.php';

        return $container->privates['App\\Repository\\ContactFormRepository'] = new \App\Repository\ContactFormRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
