...
class __TwigTemplate_24100627c93cee994d5dcfbebb782581 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Bizos, hogy törli ezt a felhasználót?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Bizos, hogy törli ezt a felhasználót?');\">
    <input  type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-danger\">Törlés</button>
</form>
", "user/_delete_form.html.twig", "C:\\xampp2\\htdocs\\ContactFormAdmin_6_3\\templates\\user\\_delete_form.html.twig");
    }
}
